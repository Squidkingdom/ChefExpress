 ...
 *   Date 2 - Programmer 1: Added categories, improved the UI, integrated video fetching, 
...
// SearchBar Component for videos
...
// SelectionCards Component to choose categories
...
// VideoModal Component to display selected video in a modal
...
const Learn = () => {
  ...
  // Fetch videos only when in 'view' mode and a category is selected
