...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  // Extract numeric price from string (remove $ if present)
    ...
    >
      <div className="relative bg-gray-800/30 rounded-2xl overflow-hidden backdrop-blur-sm 
        ...
        <div className="relative aspect-[4/3] overflow-hidden">
          <img
            src={product.img} // Using img instead of image
            alt={product.name}
        ...
        <div className="p-6 flex-grow flex flex-col">
          ...
          <p className="text-gray-400 mb-6 line-clamp-2 flex-grow">
            {product.description || product.name} {/* Fallback to name if no description */}
          </p>
          ...
          <div className="flex gap-3 mt-auto">
            ...
            <motion.a
              href={product.URL} // Using URL instead of amazonLink
              target="_blank"
